    ...
    <nav className="fixed bottom-0 inset-x-0 z-40 block md:hidden">
      ...
      <div className="border-t border-border bg-background/80 backdrop-blur-md">
        <div className="flex items-center justify-around relative">
          ...
          {/* Spacer to balance the layout (invisible) */}
          <div className="flex flex-col items-center justify-center min-w-[44px] min-h-[44px] p-2 text-xs text-transparent pointer-events-none select-none" aria-hidden>
